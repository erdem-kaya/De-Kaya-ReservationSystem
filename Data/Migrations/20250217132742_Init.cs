    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoolingRoomInventories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoolingRoomInventories_CoolingRoomStatuses_RoomStatusId",
                        column: x => x.RoomStatusId,
                        principalTable: "CoolingRoomStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CoolingRoomInventories_CoolingRooms_CoolingRoomId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoolingRoomInventories_CoolingRoomId",
                table: "CoolingRoomInventories",
                column: "CoolingRoomId");

            migrationBuilder.CreateIndex(
                name: "IX_CoolingRoomInventories_RoomStatusId",
                table: "CoolingRoomInventories",
                column: "RoomStatusId");
